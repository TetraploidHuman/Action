...
let zero = self.i64_ty().const_int(0, false);
        ...
        let memcpy_fn = self.module.get_function("memcpy").unwrap();
            ...
            let slc_fn = self.module.add_function(
                "action_list_slice",
                self.list_type.fn_type(&[self.list_type.into(), i64.into(), i64.into()], false),
                None,
            );
            ...
            let li_fn = self.module.add_function(
                "action_list_insert",
                self.list_type.fn_type(&[self.list_type.into(), i64.into(), str_ty.into()], false),
                None,
            );
            ...
            let lrm_fn = self.module.add_function(
                "action_list_remove",
                self.list_type.fn_type(&[self.list_type.into(), i64.into()], false),
                None,
            );
