...
> 当前（M184 后）：**293 passed / 0 failed / 17 ignored**（310 `#[test]`）；allowlist **126** stems。
...
| ID | 目标 | 依赖 |
|----|------|------|
| **M185+** | 下一 Path B / 子集缺口（候选：`plain_block_lambda_it_ok` / `plain_block_infinite_for_return_ok`） | M184 |
