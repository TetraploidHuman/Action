...
> 当前（M161 后）：**247 passed / 0 failed / 17 ignored**（264 `#[test]`）；allowlist **103** stems。
...
| ID | 目标 | 依赖 |
|----|------|------|
| **M162+** | 下一 Path B / 子集缺口（候选：`plain_block_cmp_ok`） | M161 |
...
| `doc/bootstrap-subset.md` | 子集允许/禁止 + M4–M161 状态表 |
