...
`bootstrap_subset`：**159 passed / 17 ignored**（含 M4–M20、TC1–TC10、M72–M116、AOT/JIT 子进程隔离；allowlist 58 stems）。
...
- **M72+**：见 `doc/bootstrap-m72-plan.md`（M72–M116 ✅；含 import/external funSig + 有 sig 时 call 检查）
