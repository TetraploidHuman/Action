...
`bootstrap_subset`：**172+ passed / 17 ignored**（含 M4–M20、TC1–TC10、M72–M122、AOT/JIT 子进程隔离；allowlist 64 stems）。
...
- **M72+**：见 `doc/bootstrap-m72-plan.md`（M72–M122 ✅；含 nullary UFCS、`or {}`、lambda/`it`/多参/trailing、开放 import 图、funSig）
