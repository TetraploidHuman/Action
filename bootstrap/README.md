...
见 `doc/bootstrap-subset.md`。**M27–M71** ✅；**M72–M170** ✅（权威状态见 [`doc/bootstrap-m72-plan.md`](../doc/bootstrap-m72-plan.md)）。
...
`bootstrap_subset`：**265 passed / 17 ignored**（含 M4–M20、TC1–TC10、M72–M170、AOT/JIT 子进程隔离；allowlist 112 stems）。
