...
`bootstrap_subset`：**163+ passed / 17 ignored**（含 M4–M20、TC1–TC10、M72–M118、AOT/JIT 子进程隔离；allowlist 60 stems）。
...
- **M72+**：见 `doc/bootstrap-m72-plan.md`（M72–M118 ✅；含 nullary UFCS、`or {}`、import/external funSig）
