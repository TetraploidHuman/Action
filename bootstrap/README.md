...
`bootstrap_subset`：**161 passed / 17 ignored**（含 M4–M20、TC1–TC10、M72–M117、AOT/JIT 子进程隔离；allowlist 59 stems）。
...
- **M72+**：见 `doc/bootstrap-m72-plan.md`（M72–M117 ✅；含 nullary UFCS `x.len()` + import/external funSig）
