...
use crate::{llvm_err, CodeGen, Scope, TypedValue};
...
impl<'ctx> CodeGen<'ctx> {
    ...
    pub(crate) fn builtin_coroutine_scope(
        &mut self,
        _args: &[CallArg<'_>],
        trailing: Option<CallArg<'_>>,
    ) -> Result<TypedValue<'ctx>, String> {
    ...
    pub(crate) fn push_to_collector(
        &mut self,
