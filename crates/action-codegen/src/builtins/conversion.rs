...
impl<'ctx> CodeGen<'ctx> {
    pub(crate) fn builtin_to_list_call_arg(
        &mut self,
        arg: CallArg<'_>,
    ...
    pub(crate) fn builtin_to_lazy_list_call_arg(
        &mut self,
        arg: CallArg<'_>,
    ) -> Result<TypedValue<'ctx>, String> {
        let val = self.compile_call_arg(arg)?;
    ...
    pub(crate) fn builtin_to_list_value(
        &mut self,
        val: TypedValue<'ctx>,
    ) -> Result<TypedValue<'ctx>, String> {
        match val {
    ...
    pub(crate) fn builtin_to_lazy_list_value(
        &mut self,
        val: TypedValue<'ctx>,
    ) -> Result<TypedValue<'ctx>, String> {
        match val {
