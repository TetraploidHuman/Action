// Submodule: runtime_decl/misc (R7)
...
impl<'ctx> CodeGen<'ctx> {
    pub(super) fn define_misc(&self) -> Result<(), String> {
        ...
        let _qsort_fn = self.module.get_function("qsort").unwrap();
        let _elem_sz = i64.const_int(16, false);
        let _zero_i64 = i64.const_int(0, false);
        let _one_i64 = i64.const_int(1, false);

        self.define_misc_sort()?;
